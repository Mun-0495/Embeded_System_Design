...
#define GICD_ICACTIVER(x) 	(*(volatile unsigned int*)(GICD_BASE_ADDR + 0x300 + x*4))
...
#define GICC_CTRL  		(*(volatile unsigned int*)(GICC_BASE_ADDR + 0x00))
#define GICC_PMR  		(*(volatile unsigned int*)(GICC_BASE_ADDR + 0x04))
#define GICC_IAR  		(*(volatile unsigned int*)(GICC_BASE_ADDR + 0x0C))
